...
%% TODO: přehled základních technik objektového návrhu (inheritance, composition, interfaces, atd.)
...
%% TODO: zjistit, jaké další objektově orientované návrhové principy (kromě těch ze zadání) existují a přidat alespoň zmínku
\end{itemize}

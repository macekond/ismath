...
\begin{itemize}
\item predikáty,
\item vrcholové selektory,
\item hranové selektory.
\end{itemize}

\subsubsection{Operace poskytované rozhraním OperatorIface}
\begin{itemize}
...
\end{itemize}
% TODO: v implementaci popsat textový výstup

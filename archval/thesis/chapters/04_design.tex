...
\begin{itemize}
\item GraphGeneratorIface -- rozhraní generátoru grafu,
\item OperatorIface -- rozhraní operátorů (selektorů a predikátů),
\item AnalysisIface -- rozhraní analytických modulů,
\item OutputGeneratorIface -- rozhraní výstupního modulu.
\end{itemize}
...
\end{figure}
Jeho dekompozice bude provedena v dalších sekcích.

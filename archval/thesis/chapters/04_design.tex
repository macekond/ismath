...
% TODO: aktualizovat (gramatika byla přesunuta)
...
\begin{table}
  ...
  \begin{center}
    \begin{tabular*}{1.0\textwidth}{@{\extracolsep{\fill}} | l | l | p{8cm} | }
      ...
      OutputGeneratorManager & class & použije některé z dostupných poskytovatelů pro generování výstupu pro vygenerování reportu \\ \hline
      \hline
      GraphGeneratorRegisterIface & interface & rozhraní registru existujících poskytovatelů generátorů grafu \\ \hline
      OperatorRegisterIface & interface & rozhraní registru existujících poskytovatelů operátorů \\ \hline
      AnalysesRegisterIface & interface & rozhraní registru poskytovatelů komponent analýzy \\ \hline
      OutputGeneratorRegisterIface & interface & rozhraní registru poskytovatelů generátorů výstupních reportů \\ \hline
    \end{tabular*}
  \end{center}

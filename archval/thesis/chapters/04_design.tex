...
Nyní se podívejme na vlastní rozhraní, která musí být implementovaná poskytovali služeb poskytovaných prostřednictvím výše zmíněných registrů.
...
\end{itemize}
\begin{itemize}
\item \emph{vstup:} adresář vstupního projektu
